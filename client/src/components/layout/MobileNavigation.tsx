  ...
  return (
    <div className="md:hidden bg-white dark:bg-surface-dark border-t border-gray-200 dark:border-gray-800 fixed bottom-0 inset-x-0 z-10">
      <div className="flex justify-around">
        ...
        <Link href="/search" className={`flex flex-col items-center p-3 ${
            location === '/search' 
              ? 'text-primary dark:text-primary-light' 
              : 'text-gray-500 dark:text-gray-400'
          }`}>
        ...
        <Link href="/messages" className={`flex flex-col items-center p-3 ${
            location === '/messages' 
              ? 'text-primary dark:text-primary-light' 
              : 'text-gray-500 dark:text-gray-400'
          }`}>
        ...
        <Link href="/profile" className={`flex flex-col items-center p-3 ${
            location === '/profile' 
              ? 'text-primary dark:text-primary-light' 
              : 'text-gray-500 dark:text-gray-400'
          }`}>
